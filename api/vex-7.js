export default async function handler(req, res) {
  const targetUrl = 'https://html5.gamedistribution.com/0c454c9562d249d28ba3a2b50564042c/';
  ...
  try {
    ...
    res.status(500).json({ error: 'Failed to fetch Vex 7', details: error.message });
  }
}
